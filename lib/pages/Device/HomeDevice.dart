...
class HomeDevice extends StatelessWidget with NavigationStates {
  @override
...
class MyHomeDevice extends StatefulWidget {
  MyHomeDevice({Key key, this.title}) : super(key: key);
  final String title;

  MyHomeDeviceState createState() => MyHomeDeviceState();
}

class MyHomeDeviceState extends State<MyHomeDevice> {
  @override
  void initState() {
    super.initState();
